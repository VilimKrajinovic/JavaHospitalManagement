...
public class UpdatePatient extends javax.swing.JFrame {
    ...
    public UpdatePatient(PatientFull patient) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlContactAndAddressLayout.setHorizontalGroup(
            ...
            .addGroup(pnlContactAndAddressLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlContactAndAddressLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ContactDetailsAddress nextAddress = new ContactDetailsAddress();
            nextAddress.setCity(txtNokCity.getText());
            nextAddress.setStreet(txtNokStreet.getText());
            nextAddress.setArea(txtNokArea.getText());
            nextAddress.setDoorNumber(txtNokDoorNr.getText());
            nextAddress.setState(txtNokState.getText());
            nextAddress.setPincode(txtNokPincode.getText());
            repo.updateContactDetailsAddress(repo.getSource(),
                    patient.getPatientShortData().getNextOfKin().getAddressDetails().getIdContactDetailsAddress(),
                    nextAddress.getDoorNumber(),
                    nextAddress.getStreet(),
                    nextAddress.getArea(),
                    nextAddress.getCity(),
                    nextAddress.getState(),
                    nextAddress.getPincode());

            ContactDetailsContact nextContact = new ContactDetailsContact();
            nextContact.setEmail(txtNokEmail.getText());
            nextContact.setFax(txtNokFax.getText());
            nextContact.setPager(txtNokPager.getText());
            nextContact.setTelephoneHome(txtNokPhoneHome.getText());
            nextContact.setTelephoneWork(txtNokPhoneWork.getText());
            nextContact.setTelephoneMobile(txtNokMobile.getText());
            repo.UpdateContactDetailsContact(repo.getSource(),
                    patient.getPatientShortData().getNextOfKin().getContactDetails().getIdContactDetailsContact(),
                    nextContact.getTelephoneWork(),
                    nextContact.getTelephoneHome(),
                    nextContact.getTelephoneMobile(),
                    nextContact.getPager(),
                    nextContact.getFax(),
                    nextContact.getEmail());
            ...
            nok.setAddressDetails(nextAddress);
            nok.setContactDetails(nextContact);
            repo.updateNextOfKin(repo.getSource(), patient.getPatientShortData().getNextOfKin().getIdNextOfKin(),
                    nok.getName(),
                    nok.getSurname(),
                    nok.getMiddlename(),
                    nok.getRelationship());

            ContactDetailsContact patContact = new ContactDetailsContact();
            patContact.setEmail(txtPatEmail.getText());
            patContact.setFax(txtPatFax.getText());
            patContact.setPager(txtPatPager.getText());
            patContact.setTelephoneHome(txtPatPhoneHome.getText());
            patContact.setTelephoneWork(txtPatPhoneWork.getText());
            patContact.setTelephoneMobile(txtPatMobile.getText());
            repo.UpdateContactDetailsContact(repo.getSource(), patient.getContactDetails().getIdContactDetailsContact(),
                    patContact.getTelephoneWork(),
                    patContact.getTelephoneHome(),
                    patContact.getTelephoneMobile(),
                    patContact.getPager(),
                    patContact.getFax(),
                    patContact.getEmail());

            ContactDetailsAddress patPermAddres = new ContactDetailsAddress();
            patPermAddres.setCity(txtPermAddrCity.getText());
            patPermAddres.setStreet(txtPermAddrStreet.getText());
            patPermAddres.setArea(txtPermAddrArea.getText());
            patPermAddres.setDoorNumber(txtPermAddrDoorNr.getText());
            patPermAddres.setState(txtPermAddrState.getText());
            patPermAddres.setPincode(txtPermAddrPincode.getText());
            repo.updateContactDetailsAddress(repo.getSource(),
                    patient.getPermanentAddress().getIdContactDetailsAddress(),
                    patPermAddres.getDoorNumber(),
                    patPermAddres.getStreet(),
                    patPermAddres.getArea(),
                    patPermAddres.getCity(),
                    patPermAddres.getState(),
                    patPermAddres.getPincode());

            ContactDetailsAddress patPresentAddr = new ContactDetailsAddress();
            patPresentAddr.setCity(txtPresAddrCity.getText());
            patPresentAddr.setStreet(txtPresAddrStreet.getText());
            patPresentAddr.setArea(txtPresAddrArea.getText());
            patPresentAddr.setDoorNumber(txtPresAddrDoorNr.getText());
            patPresentAddr.setState(txtPresAddrState.getText());
            patPresentAddr.setPincode(txtPresAddrPincode.getText());
            repo.updateContactDetailsAddress(repo.getSource(),
                    patient.getPresentAddress().getIdContactDetailsAddress(),
                    patPresentAddr.getDoorNumber(),
                    patPresentAddr.getStreet(),
                    patPresentAddr.getArea(),
                    patPresentAddr.getCity(),
                    patPresentAddr.getState(),
                    patPresentAddr.getPincode());

            PersonalDetails personalDetails = new PersonalDetails();
            personalDetails.setBloodType(txtBloodType.getText());
            personalDetails.setHeight(txtHeight.getText());
            personalDetails.setWeight(txtWeight.getText());
            personalDetails.setMaritalStatus(txtMaritalStatus.getText());
            personalDetails.setNumberOfDependents(txtNumOfDependents.getText());
            repo.updatePersonalDetails(repo.getSource(),
            ...
            proffesionDetails.setGrossAnnualIncome(Integer.parseInt(txtAnnualIncome.getText()));
            proffesionDetails.setOccupation(txtOccupation.getText());
            repo.updateProffessionDetails(repo.getSource(),
                    patient.getProffesionDetails().getIdProffessionDetails(),
                    proffesionDetails.getOccupation(),
                    proffesionDetails.getGrossAnnualIncome());

            Lifestyle lifestyle = new Lifestyle();
            lifestyle.setIsSmoker(cbSmoker.isSelected());
            lifestyle.setAverageNoOfCigarettes(Integer.parseInt(txtAverageCigarettes.getText()));
            lifestyle.setIsAlcoholic(cbAlcoholic.isSelected());
            lifestyle.setAverageNoOfDrinks(Integer.parseInt(txtAverageDrinks.getText()));
            lifestyle.setUseStimulants(txtStimulants.getText());
            lifestyle.setConsumptionOfCoffeeAndTea(Integer.parseInt(txtAverageCoffee.getText()));
            lifestyle.setConsumptionOfSoftDrinks(Integer.parseInt(txtAverageSoftDrinks.getText()));
            lifestyle.setEatsHomeFood(cbHomeFood.isSelected());
            lifestyle.setHaveRegularMeals(cbRegularMeals.isSelected());
            lifestyle.setIsVegetarian(cbVegetarian.isSelected());
            ...
            BasicComplaints basicComplaint = new BasicComplaints();
            basicComplaint.setHistoryOfPreviousTreatment(txtPrevTreatment.getText());
            basicComplaint.setPhysicianOrHospital(txtPhysOrHosp.getText());
            basicComplaint.setStatementOfComplaint(txtSoC.getText());
            repo.updateBasicComplaints(repo.getSource(), patient.getBasicComplaints().getIdBasicComplaints(),
                    basicComplaint.getStatementOfComplaint(),
                    basicComplaint.getHistoryOfPreviousTreatment(),
                    basicComplaint.getPhysicianOrHospital());

            ImportantMedicalComplaints importantComplaints = new ImportantMedicalComplaints();
            importantComplaints.setCardiacCondition(txtCardiacCondition.getText());
            importantComplaints.setDigestiveCondition(txtDigestiveCondition.getText());
            importantComplaints.setIsDiabetic(cbDiabetic.isSelected());
            importantComplaints.setIsHypertenisve(cbHypertensive.isSelected());
            importantComplaints.setKnownAllegries(txtKnownAlergies.getText());
            importantComplaints.setKnownReactionToDrugs(txtReactionToDrugs.getText());
            importantComplaints.setMajorSurgeries(txtMajorSurgeries.getText());
            importantComplaints.setMuscularCondition(txtMuscularCondition.getText());
            importantComplaints.setNeurologicalCondition(txtNeurologicalCondition.getText());
            importantComplaints.setOrthopedicCondition(txtOrthopedicCondition.getText());
            repo.updateImportantMedicalComplaints(repo.getSource(), patient.getMedicalComplaints().getIdImportantMedicalComplaints(),
                    importantComplaints.isIsDiabetic(),
                    importantComplaints.isIsHypertenisve(),
            ...
            patientShort.setName(txtPatientName.getText().trim());
            patientShort.setSurname(txtPatientSurname.getText().trim());
            patientShort.setMiddlename(txtPatientMiddlename.getText().trim());
            patientShort.setContact_1(txtPatPhoneHome.getText().trim());
            patientShort.setContact_2(txtPatPhoneWork.getText().trim());
            patientShort.setSex(rbtnMale.isSelected() ? "M" : "F");
            patientShort.setIsFollowUp(false);
            patientShort.setNextOfKin(nok);
            patientShort.setStatementOfComplaint(txtSoC.getText().trim());
            repo.updatePatient(repo.getSource(),
                    patient.getPatientShortData().getIdPatient(),
                    patientShort.getName(),
                    patientShort.getSurname(),
                    patientShort.getMiddlename(),
                    patientShort.getSex(),
                    patientShort.getStatementOfComplaint(),
                    patientShort.getContact_1(),
                    patientShort.getContact_2(),
                    patientShort.isIsFollowUp());

            PatientFull tmp = new PatientFull();
            tmp.setBasicComplaints(basicComplaint);
            tmp.setContactDetails(patContact);
            tmp.setDateOfBirth(new Date(datePicker.getDate().getTime()));
            tmp.setLifestyle(lifestyle);
            tmp.setMedicalComplaints(importantComplaints);
            tmp.setPatientShortData(patientShort);
            tmp.setPermanentAddress(patPermAddres);
            tmp.setPersonalDetails(personalDetails);
            tmp.setPresentAddress(patPresentAddr);
            tmp.setProffesionDetails(proffesionDetails);
            repo.updatePatientFull(repo.getSource(), patient.getIdPatientFull(), new Date(datePicker.getDate().getTime()));

            JOptionPane.showMessageDialog(this, "Patient updated sucessfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
