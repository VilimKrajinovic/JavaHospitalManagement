 ...
 * @author amd
 */
public class InsertPatientLong extends javax.swing.JFrame {

    /**
     * Creates new form InsertPatientLong
     */
    Repository repo = new Repository();

    public InsertPatientLong() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabMain, javax.swing.GroupLayout.PREFERRED_SIZE, 495, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        try {
            ...
            nextAddress.setIdContactDetailsAddress(
            ...
            nextContact.setIdContactDetailsContact(
            ...
            nok.setIdNextOfKin(repo.insertNextOfKin(repo.getSource(),
                    ...
                    nok.getMiddlename(),
                    nok.getRelationship(),
                    nextContact.getIdContactDetailsContact(),
                    nextAddress.getIdContactDetailsAddress()));
            ...
            patContact.setIdContactDetailsContact(
                    repo.insertContactDetailsContact(repo.getSource(),
            ...
            patPermAddres.setIdContactDetailsAddress(
                    repo.insertContactDetailsAddress(repo.getSource(),
            ...
            patPresentAddr.setIdContactDetailsAddress(
                    repo.insertContactDetailsAddress(repo.getSource(),
            ...
            personalDetails.setIdPersonalDetails(
                    repo.insertPersonalDetails(repo.getSource(),
            ...
            proffesionDetails.setIdProffessionDetails(
                    repo.insertProffessionDetails(repo.getSource(),
            ...
            basicComplaint.setIdBasicComplaints(repo.insertBasicComplaints(repo.getSource(),
            ...
            importantComplaints.setIdImportantMedicalComplaints(repo.insertImportantMedicalComplaints(repo.getSource(),
            ...
            patientShort.setIdPatient(repo.insertPatient(repo.getSource(),
                    ...
                    patientShort.getNextOfKin().getIdNextOfKin(),
            ...
            tmp.setIdPatientFull(repo.insertPatientFull(repo.getSource(),
                    patientShort.getIdPatient(),
                    new Date(datePicker.getDate().getTime()),
                    patPermAddres.getIdContactDetailsAddress(),
                    patPresentAddr.getIdContactDetailsAddress(),
                    personalDetails.getIdPersonalDetails(),
                    proffesionDetails.getIdProffessionDetails(),
                    lifestyle.getIdLifestyle(),
                    basicComplaint.getIdBasicComplaints(),
                    importantComplaints.getIdImportantMedicalComplaints(),
                    patContact.getIdContactDetailsContact()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertPatientLong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
